...
const dataApps = [
  ...
  { name: "SIKUMBANG",   desc: "Sistem Informasi Kumuh dan Bangunan",        link: "https://sikumbang.pkp.go.id",logo: "/design/logo_pkp.png" },
  { name: "E-PPID PKP",  desc: "Layanan Informasi Publik Kementerian PKP",   link: "https://ppid.pkp.go.id",     logo: "/design/logo_pkp.png" },
]
